...
public class Maze3D
{
    ...
    public static void main(String[] args) throws IOException {
        String barrettPath = "..\\past-competitions\\2013-2\\SampleData\\" + "maze3d.dat";

        Scanner kb = new Scanner(new File(barrettPath));
...
//
//
//    public static int solve(char[][][] maze, int r, int c, int f, int shots) {
//        if (r < 0 || r > maze.length - 1 || c < 0 || c > maze[0].length - 1 || f < 0 || f > maze[0][0].length - 1 || maze[r][c][f] == '#')
//            return 0;
//
//        int dist = 0;
//        char curr = maze[r][c][f];
//        maze[r][c][f] = '#';
//        int best = bestDistance(maze, r, c, f, shots);
//
//        if (curr == 'E')
//            dist++;
//        else if (curr == '*' && shots > 0) {
//            --shots;
//            int bestWithShot = bestDistance(maze, r, c, f, shots);
//            ++shots;
//            if (bestWithShot > 0)
//                dist += ++bestWithShot;
//        } else if (best > 0)
...
//    }
//
//    private static int bestDistance(char[][][] maze, int r, int c, int f, int shots) {
//        return List.of(
//                solve(maze, r - 1, c, f, shots), solve(maze, r + 1, c, f, shots),
//                solve(maze, r, c - 1, f, shots), solve(maze, r, c + 1, f, shots),
//                solve(maze, r, c, f - 1, shots), solve(maze, r, c, f + 1, shots))
//                .stream()
//                .filter(e -> e > 0)
//                .min(Integer::compare)
//                .orElse(0);
...
//
//        int mazes = scan.nextInt();
//        scan.nextLine();
//        for (int i = 0; i < mazes; i++) {
//
//            char[][][] maze = new char[scan.nextInt()][scan.nextInt()][scan.nextInt()];
//            scan.nextLine();
//
//            int sR = 0, sC = 0, sF = 0;
//
//            for (int f = 0; f < maze[0][0].length; ++f) {
...
//                }
//            }
//            int moves = solve(maze, sR, sC, sF, 2);
//            System.out.println(moves == 0 ? "STUCK" : moves + " MOVES");
//        }
//    }
//}
